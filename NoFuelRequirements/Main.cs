...
using NoFuelRequirements.Lib.Commands;
using NoFuelRequirements.Lib.Config;
using NoFuelRequirements.Lib.Logging;
using UnityEngine;

namespace NoFuelRequirements
{
    internal class Main
    {
        /// <summary>
        ...
        /// </summary>
        public const string ModName = "No Fuel Requirements";
        
        /// <summary>
        /// Shortname, often ToLower'ed and used for file names and command prefixes
        /// </summary>
        public const string ModShortName = "NoFuelRequirements";
